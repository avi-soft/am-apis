...
public class Constant {
    ...
    public static final String FETCH_DOCUMENT_TO_ARCHIVE_ID = "Select document_type_id FROM %s WHERE %s = :userId AND document_type_id = :documentTypeId AND archived = false";
}
