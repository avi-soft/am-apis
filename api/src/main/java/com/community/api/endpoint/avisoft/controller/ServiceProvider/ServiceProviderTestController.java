...
public class ServiceProviderTestController {
    ...
    public ResponseEntity<?> getAllTests(@PathVariable Long serviceProviderId, @RequestParam(defaultValue = "0") int page, @RequestParam(defaultValue = "30") int limit) throws EntityNotFoundException, EntityDoesNotExistsException {
    ...
    public ResponseEntity<?> getCompletedTest(@PathVariable Long serviceProviderId, HttpServletRequest request) throws EntityNotFoundException, EntityDoesNotExistsException {
        try {
    ...
    public ResponseEntity<?> giveImageTestScores(@PathVariable Long serviceProviderId, @RequestBody GiveUploadedImageScoreDTO giveUploadedImageScoreDTO) {
        try {
